  ...
  return (
    <footer className="bg-sky-900 text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-14">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="flex items-center gap-2 pt-1">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-white hover:text-white hover:bg-white/10 transition-all duration-200"
              >
        ...
        {/* Bottom Bar */}
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white">
          <p>© {new Date().getFullYear()} Ridi Power Company Limited. All rights reserved.</p>
